...
class DRN(nn.Module):
    ...
    def __init__(self, block, layers, num_cls=1000,
                 ...
                 output_last_ft=False, modelname='drn42'):
        if output_last_ft:
...
def drn26(pretrained=True, finetune=False, out_map=True, **kwargs):
    ...
    #     req = urllib.request.Request(url="https://tigress-web.princeton.edu/~fy/drn/models/drn26-ddedf421.pth", headers=headers)
    #     state_dict = urllib.request.urlopen(req).read()
    #     '''
    ...
    #     url = "https://tigress-web.princeton.edu/~fy/drn/models/drn26-ddedf421.pth"
    #     headers={'User-Agent':user_agent,} 
    #     request=urllib.request.Request(url,None,headers) #The assembled request
    #     response = urllib.request.urlopen(request)
    #     model = response.read() # The data u need
    # return model
...
def drn42(pretrained=True, finetune=False, out_map=True, **kwargs):
    print('kwargs:',kwargs)
