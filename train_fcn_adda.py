    ...
    while iteration < max_iter:
        ...
        for im_s, im_t, label_s, label_t in loader:
            ...
            if iteration % snapshot == 0:
                ...
                if not train_discrim_only:
                    torch.save(net.state_dict(),
                            '/home/liuxina/Downloads/cycada_release/results/'+'{}/net-iter{}.pth'.format(output, iteration))
                torch.save(discriminator.state_dict(),
                        '/home/liuxina/Downloads/cycada_release/results/'+'{}/discriminator-iter{}.pth'.format(output, iteration))
